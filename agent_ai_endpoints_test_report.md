...
| `/batch-match` | POST | AI Matching Engine | ❌ error | 0.711s | 422 |
| `/analyze/1` | GET | Candidate Analysis | ✅ success | 13.178s | 200 |
| `/test-db` | GET | System Diagnostics | ✅ success | 1.416s | 200 |
...
```json
{
  ...
  "analysis_timestamp": "2025-11-04T09:07:15.153128"
}
```
...
**Average Response Time:** 7.297s  
**Fastest Endpoint:** `/test-db` (1.416s)  
**Slowest Endpoint:** `/analyze/1` (13.178s)  
...
**Report Generated:** 2025-11-04 14:37:14  
**Test Duration:** 45.305s total  
