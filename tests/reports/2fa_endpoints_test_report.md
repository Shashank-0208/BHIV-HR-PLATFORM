...
|----------|--------|----------|--------|---------------|-------------|
| `/v1/auth/2fa/setup` | POST | User 2FA Auth | ❌ error | 0.653s | 422 |
| `/v1/auth/2fa/verify` | POST | User 2FA Auth | ❌ error | 0.583s | 422 |
| `/v1/auth/2fa/login` | POST | User 2FA Auth | ❌ error | 0.554s | 422 |
| `/v1/auth/2fa/status/1` | GET | User 2FA Auth | ✅ success | 0.558s | 200 |
| `/v1/auth/2fa/disable` | POST | User 2FA Auth | ❌ error | 1.438s | 422 |
| `/v1/auth/2fa/backup-codes` | POST | User 2FA Auth | ❌ error | 0.552s | 422 |
| `/v1/auth/2fa/test-token` | POST | User 2FA Auth | ❌ error | 1.266s | 422 |
| `/v1/auth/2fa/qr/1` | GET | User 2FA Auth | ✅ success | 0.663s | 200 |
| `/v1/2fa/setup` | POST | Client 2FA | ❌ error | 1.057s | 422 |
| `/v1/2fa/verify-setup` | POST | Client 2FA | ❌ error | 1.212s | 422 |
| `/v1/2fa/login-with-2fa` | POST | Client 2FA | ❌ error | 0.588s | 422 |
| `/v1/2fa/status/TECH001` | GET | Client 2FA | ✅ success | 0.604s | 200 |
| `/v1/2fa/disable` | POST | Client 2FA | ❌ error | 1.011s | 422 |
| `/v1/2fa/regenerate-backup-codes` | POST | Client 2FA | ❌ error | 0.736s | 422 |
| `/v1/2fa/test-token/TECH001/123456` | GET | Client 2FA | ✅ success | 0.726s | 200 |
| `/v1/2fa/demo-setup` | GET | Client 2FA | ✅ success | 0.707s | 200 |
...
```json
{
  ...
  "generated_at": "2025-11-03T08:57:49.950396+00:00"
}
...
```json
{
  ...
  "token": "123456",
  "is_valid": false,
  "test_timestamp": "2025-11-03T08:57:55.874490+00:00"
}
```
...
**Average Response Time:** 0.652s  
**Fastest Endpoint:** `/v1/auth/2fa/status/1` (0.558s)  
**Slowest Endpoint:** `/v1/2fa/test-token/TECH001/123456` (0.726s)  
...
**Report Generated:** 2025-11-03 14:27:54  
**Test Duration:** 12.908s total  
