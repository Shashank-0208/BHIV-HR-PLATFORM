...
|----------|--------|----------|--------|---------------|-------------|
| `/v1/security/rate-limit-status` | GET | Rate Limiting | ✅ success | 0.629s | 200 |
| `/v1/security/blocked-ips` | GET | Rate Limiting | ✅ success | 1.102s | 200 |
| `/v1/security/test-input-validation` | POST | Input Validation | ❌ error | 0.544s | 403 |
| `/v1/security/validate-email` | POST | Email Validation | ✅ success | 0.577s | 200 |
| `/v1/security/test-email-validation` | POST | Email Validation | ❌ error | 0.509s | 422 |
| `/v1/security/validate-phone` | POST | Phone Validation | ✅ success | 0.520s | 200 |
| `/v1/security/test-phone-validation` | POST | Phone Validation | ❌ error | 0.651s | 422 |
| `/v1/security/test-headers` | GET | Security Headers | ✅ success | 0.543s | 200 |
| `/v1/security/security-headers-test` | GET | Security Headers | ✅ success | 0.641s | 200 |
| `/v1/security/penetration-test` | POST | Penetration Testing | ❌ error | 0.594s | 422 |
| `/v1/security/test-auth` | GET | Authentication | ✅ success | 0.697s | 200 |
| `/v1/security/penetration-test-endpoints` | GET | Penetration Testing | ✅ success | 0.677s | 200 |
...
```json
{
  ...
  "reset_time": "2025-11-04T09:05:48.695877+00:00",
  "status": "active"
}
```
...
```json
{
  ...
  "total_blocked": 2,
  "last_updated": "2025-11-04T09:05:49.776000+00:00"
}
```
...
```json
{
  ...
  "timestamp": "2025-11-04T09:05:50.917284+00:00"
}
```
...
```json
{
  ...
  "timestamp": "2025-11-04T09:05:51.955616+00:00"
}
```
...
```json
{
  ...
  "authenticated": true,
  "api_key_valid": true,
  "timestamp": "2025-11-04T09:05:55.081220+00:00"
}
```
...
**Average Response Time:** 0.673s  
**Fastest Endpoint:** `/v1/security/validate-phone` (0.52s)  
**Slowest Endpoint:** `/v1/security/blocked-ips` (1.102s)  
...
**Report Generated:** 2025-11-04 14:35:53  
**Test Duration:** 7.684s total  
